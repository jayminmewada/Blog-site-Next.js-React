...
export default async function (req, res) {
    ...
    for (const propertyy of picture) {

        Imageinfo.push(propertyy.img);
    ...
    for (const propert of para) {

        Parainfo.push(propert.hello);

    }
    console.log(Parainfo.toString());
    ...
    console.log("  "+Imageinfo.toString())
    ...
    var mailData = {
        ...
        <tr>
        <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 200px; padding-right: 5px;"><img align="center" class="icon" height="250" src= `+Imageinfo.toString()+`style="display: block; height: auto; margin: 0 auto; border: 0;" width='250' center=auto/></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <h1 style="margin: 0; color: #272727; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 48px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>IPHONE 14 why you should buy it ?</strong></h1>
        </td>
        </tr>
        </table>
        ...
        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 32px;"><span style="font-size:16px;">`+ Parainfo.toString() + `</span></p>
        </div>
        </div>
        </td>
        </tr>
        ...
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:44px;width:149px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#133C55" fillcolor="#133c55"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a href="https://www.gadgetsnow.com/mobile-phones/Apple-iPhone-14" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#133c55;border-radius:4px;width:auto;border-top:1px solid #133C55;font-weight:undefined;border-right:1px solid #133C55;border-bottom:1px solid #133C55;border-left:1px solid #133C55;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 32px;">LEARN MORE</span></span></a>
    ...
    cron.schedule("12 46 * * MON", function () {
